...
<head>
    ...
    <link href="/style02.css" media="all" rel="stylesheet" type="text/css"/>
</head>
<body>
<div class="container">    
    ...
    function refreshVariable(){
        ...
        global $firstname , $lastname , $birthdate , $email , $gender , $phone , $runtype , $ticketprice , $clothsize , 
        $deliveryType , $profilepic , $csvErr;
        
        $firstname = $lastname = $birthdate = $email = $gender = $phone = $runtype = $ticketprice = $clothsize = 
        $deliveryType = $profilepic = $csvErr ="";
    }
    ?>
    <?php
    ...
    <div class="row container-body">
        ...
        <?php
            ...
            echo "<h5>ประเภทการวิ่ง : ".$runtype."<h5>";
